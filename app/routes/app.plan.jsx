  ...
  const getBannerContent = () => {
    if (isBypassEnabled) {
      return {
        ...
        status: 'success',
        content:
          'You are currently on the Free Plan with full access to all features.',
      };
    }
            ...
            <BlockStack gap={'4'}>
              <Text as={'h2'} variant={'headingMd'}>
                {isBypassEnabled
                  ...
                  : isActive
                    ...
                    : 'Subscription to Instafeed app'}
              </Text>
              {isBypassEnabled ? (
                <>
                  <Text as={'p'}>
                    You are currently enjoying our Free Plan with unlimited
                    access to all features.
                  </Text>
                  <List type={'bullet'}>
                    <List.Item>
                      Connect Instagram business accounts with OAuth
                      authorization
                    </List.Item>
                    <List.Item>
                    ...
                    <List.Item>Unlimited posts and media access</List.Item>
                  </List>
                  <Text as={'p'}>
                    Plan Status: <strong>Active</strong> | Expires:{' '}
                    <strong>Never</strong>
                  </Text>
                </>
              ) : (
                !isActive && (
                  <>
                    <Text as={'p'}>
                      Get full access to all features with our affordable
                      monthly plan.
                    </Text>
                    <List type={'bullet'}>
                      <List.Item>
              ...
              {!isBypassEnabled && (
                <Button
                  primary={!isActive}
                  target={'_top'}
                  url={`https://admin.shopify.com/charges/instafeed-sprinix/pricing_plans`}
                >
